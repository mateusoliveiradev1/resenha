...
export default function NovoPostPage() {
    ...
    const {
        ...
        resolver: zodResolver(CreatePostSchema) as Resolver<CreatePostInput>,
        defaultValues: {
            title: "",
            content: "",
            coverImage: null,
    ...
    const submitPost = async (data: CreatePostInput, mode: SubmitMode) => {
        ...
        setFormFeedback(result.error ?? "Nao foi possivel salvar o post.");
    };
    ...
    return (
        <div className="mx-auto max-w-4xl space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="font-display text-2xl font-bold tracking-tight text-cream-100">Novo Post</h1>
                    <p className="mt-1 text-sm text-cream-300">Crie uma noticia real do clube e publique no site sem depender de mock.</p>
                </div>
            </div>
                    ...
                    <CardContent className="space-y-8 p-6">
                            ...
                            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                ...
                                <div className="sm:col-span-2">
                                    <FormField
                                        ...
                                        placeholder="Cole o ID da partida se quiser relacionar este post a um jogo"
                                        {...register("matchId", {
                                            setValueAs: (value) => normalizeOptionalValue(value)
                                        })}
                        ...
                        <div className="space-y-4">
                            ...
                            <RosterPhotoUploadField
                                ...
                                helperText="Opcional. Pode mandar JPG, PNG ou WEBP em qualquer tamanho razoavel. O painel ajusta para 1600x900 e comprime automaticamente."
                        ...
                        <div className="space-y-2">
                            ...
                            <textarea
                                ...
                                placeholder="Escreva aqui a noticia, cronica ou resumo da partida..."
                            />
                            ...
                            <p className="text-[0.8rem] text-cream-300">
                                Resumo, slug e tempo de leitura sao calculados automaticamente.
                            </p>
                        </div>
                        ...
                        <div className="flex flex-col gap-3 border-t border-navy-800 pt-4 sm:flex-row sm:justify-end">
                            ...
                            >
                                ...
                                {isSubmitting && pendingMode === "draft" ? "Salvando..." : "Salvar rascunho"}
                            </Button>
                            <Button
                                type="button"
                                variant="primary"
                            ...
                            >
                                ...
                                {isSubmitting && pendingMode === "publish" ? "Publicando..." : "Publicar agora"}
                            </Button>
                        </div>
                    </CardContent>
                </Card>
